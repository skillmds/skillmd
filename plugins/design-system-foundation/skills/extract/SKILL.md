---
name: extract
description: Identifies reusable UI patterns, components, and design tokens, then extracts and consolidates them into a design system for systematic reuse.
---
