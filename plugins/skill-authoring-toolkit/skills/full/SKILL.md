---
name: full
description: Consolidates 89 high-integrity SOPs for the Full department of the Galyarder Framework, covering adapter creation, execution protocols, and multi-agent hygiene.
---
...
- **Problem:** Remove worktree when might
