...
https://skillmd.com/plugins/skillmd/brand-identity-kit
...
command installs it, adding the marketplace on the way:
    ...
    npx skillmds@latest add plugin:skillmd/brand-identity-kit

Or add `skillmds/skillmd` as a marketplace in the Plugins tab, then:

    /plugin install brand-identity-kit@skillmd
...
- aica
- maxim-brand
- logo-concepts-editable-svg-logo-directions-you-can-ship
- auto-skiller-brand
- ckm-brand
- ckm-design
