...
https://skillmd.com/plugins/skillmd/build-multi-agent-system-with-crewai
...
command installs it, adding the marketplace on the way:
    ...
    npx skillmds@latest add plugin:skillmd/build-multi-agent-system-with-crewai

Or add `skillmds/skillmd` as a marketplace in the Plugins tab, then:

    /plugin install build-multi-agent-system-with-crewai@skillmd
...
- whd4-crewai
- crewai-multi-agent
- rootcastleco-ai-engineer
- lingxling-crewai
- nimoqup046-collab-crewai
